 ...
 */
final class Version20230623162215 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE association ADD updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE address_id address_id INT DEFAULT NULL');
        $this->addSql('DROP INDEX IDX_8D35182A1FB8D185 ON lodging');
        $this->addSql('ALTER TABLE lodging CHANGE host_id user_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD nombre_lit INT DEFAULT NULL, ADD description LONGTEXT DEFAULT NULL, ADD entreprise VARCHAR(255) DEFAULT NULL, ADD fonction VARCHAR(255) DEFAULT NULL, DROP email_user, CHANGE address_id address_id INT DEFAULT NULL, CHANGE phone_user phone_user VARCHAR(255) DEFAULT NULL, CHANGE gender gender VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE guest ADD CONSTRAINT FK_ACB79A35EFB9C8A5 FOREIGN KEY (association_id) REFERENCES association (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE address ADD department_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE matched ADD CONSTRAINT FK_85F5907D9A4AA658 FOREIGN KEY (guest_id) REFERENCES guest (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_85F5907D9A4AA658 ON matched (guest_id)');
        $this->addSql('ALTER TABLE association DROP updated_at, CHANGE address_id address_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE lodging CHANGE user_id host_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD email_user VARCHAR(255) NOT NULL, DROP nombre_lit, DROP description, DROP entreprise, DROP fonction, CHANGE address_id address_id INT NOT NULL, CHANGE phone_user phone_user VARCHAR(255) NOT NULL, CHANGE gender gender VARCHAR(255) NOT NULL');
    }
}
