 ...
 */
final class Version20230619135156 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, department_id INT DEFAULT NULL, street_number VARCHAR(255) NOT NULL, street_name VARCHAR(255) NOT NULL, zip_code VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, INDEX IDX_D4E6F81AE80F5DF (department_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE association (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, name_asso VARCHAR(255) NOT NULL, description_asso LONGTEXT DEFAULT NULL, website_url VARCHAR(255) DEFAULT NULL, image_name_asso VARCHAR(255) DEFAULT NULL, phone_number_asso VARCHAR(255) NOT NULL, email_asso VARCHAR(255) DEFAULT NULL, slug_asso VARCHAR(255) NOT NULL, INDEX IDX_FD8521CCF5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lodging (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, department_id INT DEFAULT NULL, description_lod LONGTEXT DEFAULT NULL, image_name_lod VARCHAR(255) DEFAULT NULL, longitude DOUBLE PRECISION NOT NULL, latitude DOUBLE PRECISION NOT NULL, slug_lod VARCHAR(255) NOT NULL, title_lod VARCHAR(255) NOT NULL, INDEX IDX_8D35182A12469DE2 (category_id), INDEX IDX_8D35182AAE80F5DF (department_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE matched (id INT AUTO_INCREMENT NOT NULL, lodging_id INT DEFAULT NULL, INDEX IDX_85F5907D87335AF1 (lodging_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, email_user VARCHAR(255) NOT NULL, phone_user VARCHAR(255) NOT NULL, image_name_user VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', gender VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, nombre_lit INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, entreprise VARCHAR(255) DEFAULT NULL, fonction VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
