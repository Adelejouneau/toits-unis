 ...
 */
final class Version20230717215100 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE association_department (association_id INT NOT NULL, department_id INT NOT NULL, INDEX IDX_EDD68330EFB9C8A5 (association_id), INDEX IDX_EDD68330AE80F5DF (department_id), PRIMARY KEY(association_id, department_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE association_department ADD CONSTRAINT FK_EDD68330AE80F5DF FOREIGN KEY (department_id) REFERENCES department (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE association_department ADD CONSTRAINT FK_EDD68330EFB9C8A5 FOREIGN KEY (association_id) REFERENCES association (id) ON UPDATE NO ACTION ON DELETE CASCADE');
