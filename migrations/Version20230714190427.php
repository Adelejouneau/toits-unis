 ...
 */
final class Version20230714190427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipement DROP cuisine_couvert, DROP cusine_micro_onde, DROP cuisine_plaque_cuisson, DROP sanitaire_toilette, DROP sanitaire_lavabo, DROP sanitaire_douche, DROP couchage_lit, DROP couchage_canape, DROP couchage_autre, DROP nbr_de_lit');
    }
