 ...
 */
final class Version20230711075011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lodging ADD host_id INT DEFAULT NULL, ADD address_lod LONGTEXT NOT NULL, ADD city_lod VARCHAR(255) NOT NULL, DROP longitude, DROP latitude, CHANGE user_id zipcode_lod INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lodging ADD longitude DOUBLE PRECISION NOT NULL, ADD latitude DOUBLE PRECISION NOT NULL, DROP host_id, DROP address_lod, DROP city_lod, CHANGE zipcode_lod user_id INT NOT NULL');
